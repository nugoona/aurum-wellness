...
export const metadata: Metadata = {
  ...
  title: {
    default: '아우름웰니스 | 인천 부평 프리미엄 뷰티 & 웰니스 테라피',
    template: '%s | 아우름웰니스',
  },
  description: `인천 부평 프리미엄 뷰티 & 웰니스 테라피. 아로마 스웨디시, 건식 스포츠 테라피, 경락 윤곽 관리, 딸고(THALGO) 인증 트리트먼트. 네이버 예약 평균 4.97점, ${REVIEW_DATA.length}건 리뷰. 부평시장역 3번 출구 20m.`,
  keywords: '아우름웰니스, 인천 테라피, 부평 마사지, 아로마 스웨디시, 건식 스포츠 마사지, 경락 윤곽, 딸고 케어, 산전 산후 케어, 웰니스 테라피, 인천 부평',
  alternates: {
    canonical: 'https://www.aurumwellness.co.kr',
  },
  openGraph: {
    title: '아우름웰니스 | 프리미엄 뷰티 & 웰니스 테라피',
...
const jsonLd = {
  ...
  description: '전문성과 품격을 동시에 갖춘 프리미엄 뷰티 & 웰니스 테라피. 아로마 스웨디시, 건식 스포츠 테라피, 경락 윤곽 관리, 딸고(THALGO) 인증 트리트먼트.',
  url: 'https://www.aurumwellness.co.kr',
